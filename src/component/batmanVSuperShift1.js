...
class cinemaPage extends Component {
    state = { 
        kursiData: [],
        kursiBooked: [],
        movie: "batman v superman studio 3 morning"
    }

    getKursiData = () => {
        axios.get( API_URL_1 + "/batVSuperShift1" )
        .then( dataBaseKursi => {
    ...
    onCheckOutClick = () => {
        if(this.props.userLogin.username != "") {
            ...
            axios.put(API_URL_1 + "/batVSuperShift1/" + kursiYgDiBook, {
                status: "booked" 
            })
            .then( (kursi) => {
                console.log(kursi)
    ...
    render() {
        ...
        return (
            ...
            <div className="container text-center" style={{width:"500px"}}>
                <h3>Batman V Superman morning</h3>
